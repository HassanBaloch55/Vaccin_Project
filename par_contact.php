 ...
 ?>
   ...
   <div class="container">
    <div class="row">
      <div class="col-md-4"><div class="page">
        <i class="fa-brands fa-rocketchat fa-2xl" style="color: rgb(0, 0, 0);"></i> <br>
        <span>
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="page">
          <i class="fa fa-location-arrow  fa-2xl" aria-hidden="true" style="color: #b19809;"></i> <br>
          <span>
  ...
  <div class="row">
    ...
    <div class="col-md-4">
      <div class="page">
        <i class="fa-brands fa-linkedin fa-2xl" style="color: rgb(10, 34, 78);"></i> <br>
      <span>

...
include 'connect.php';
 if (isset($_POST['update'])) {
     ...
     // Update the record in the database
       $sql = "UPDATE   parents_register  SET  User_name ='$User',Email = '$email' , City ='$City', Contact = '$phone',image = '$filename' where Id = '$id'";
     $result = mysqli_query($conn, $sql);
 
     if ($result) {
         echo "Record updated successfully";
         header("Location:Edit_par_profile.php");
                   ...
                   <div class="row">
                      <div class="form-group col-md-2">
                       ...
                       <div class="form-group col-md-5">
                         ...
                         <input type="text" class="form-control" value="<?php echo $row ['User_Name']; ?>" id="user_name" name="User_Name" required>
                     </div>
                         <div class="form-group col-md-5">
                         ...
                         <div class="form-group col-md-6">
                             ...
                             <input type="text" class="form-control" value="<?php echo $row ['Contact']; ?>"  id="Contact" name="Contact" required>
                         </div>
                         <div class="form-group col-md-6">
